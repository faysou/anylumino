...
<PyFunction name="__init__" type="(items, value=None, *, label='', disabled=False, placeholder=None, size=None, clear=None, search=None, search_placeholder=None, label_hidden=None, description=None, status=None, **props) -> None" kind="constructor">
  <PySourceCode>
    ```python
    def __init__(
        self,
