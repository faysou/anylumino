...
<PyFunction name="__init__" type="(value=0, *, label='', label_position='top', label_width=None, disabled=False, min=None, max=None, step=None, orientation=None, value_display=None, marks=None, description=None, status=None, **props) -> None" kind="constructor">
  <PySourceCode>
    ```python
    def __init__(
        self,
