...
<PyFunction name="__init__" type="(value='', *, label='', placeholder='', disabled=False, input_type=None, size=None, label_hidden=None, description=None, optional=None, required=None, loading=None, status=None, clear=None, auto_focus=None, select_on_focus=None, **props) -> None" kind="constructor">
  <PySourceCode>
    ```python
    def __init__(
        self,
