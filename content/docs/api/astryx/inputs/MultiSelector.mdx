...
<PyFunction name="__init__" type="(items, value=(), *, label='', disabled=False, placeholder=None, size=None, loading=None, clear=None, select_all=None, search=None, trigger_display=None, max_badges=None, description=None, status=None, **props) -> None" kind="constructor">
  <PySourceCode>
    ```python
    def __init__(
        self,
