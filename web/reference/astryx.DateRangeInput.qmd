...
| min              | str \| None                             | Minimum ISO date.                                                                           | `None`    |
| max              | str \| None                             | Maximum ISO date.                                                                           | `None`    |
| presets          | Iterable\[Mapping\[str, Any\]\] \| None | Named date-range presets.                                                                   | `None`    |
