...
| orientation  | str \| None                 | Vertical or horizontal item layout.                                                    | `None`     |
| disabled     | bool                        | Whether all radio items are disabled.                                                  | `False`    |
| size         | str \| None                 | Radio control size.                                                                    | `None`     |
