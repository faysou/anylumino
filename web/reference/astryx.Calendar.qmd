...
| number_of_months | int \| None                        | Number of months displayed.                                                           | `None`     |
| min              | str \| None                        | Minimum selectable ISO date.                                                          | `None`     |
| max              | str \| None                        | Maximum selectable ISO date.                                                          | `None`     |
| outside_days     | bool \| None                       | Whether to show dates from adjacent months.                                           | `None`     |
| week_numbers     | bool \| None                       | Whether to show ISO week numbers.                                                     | `None`     |
| variable_rows    | bool \| None                       | Whether the calendar uses a variable row count.                                       | `None`     |
| week_starts_on   | int \| str \| None                 | First day of the week.                                                                | `None`     |
