...
| min           | int \| float \| None                                                        | Minimum slider value.                                                               | `None`    |
| max           | int \| float \| None                                                        | Maximum slider value.                                                               | `None`    |
| step          | int \| float \| None                                                        | Slider step increment.                                                              | `None`    |
| orientation   | str \| None                                                                 | Horizontal or vertical orientation.                                                 | `None`    |
| value_display | str \| None                                                                 | Tooltip, text, or hidden value presentation.                                        | `None`    |
| marks         | Iterable\[Mapping\[str, Any\]\] \| None                                     | Optional slider tick-mark records.                                                  | `None`    |
| description   | str \| None                                                                 | Helper text displayed with the slider.                                              | `None`    |
