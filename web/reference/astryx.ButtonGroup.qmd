...
| action_callbacks | Iterable\[Callable\[\[ComponentWidget, Any\], None\]\] \| None | Python callbacks receiving the selected item value.                                      | `None`     |
| orientation      | str \| None                                                    | Horizontal or vertical group orientation.                                                | `None`     |
| size             | str \| None                                                    | Default child button size.                                                               | `None`     |
| disabled         | bool                                                           | Whether all buttons are disabled.                                                        | `False`    |
