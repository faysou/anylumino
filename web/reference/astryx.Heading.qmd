...
```python
astryx.Heading(text, *, level=3, props=None, **kwargs)
```
...
| props  | Mapping\[str, Any\] \| None | JSON-safe Heading props forwarded to Astryx. See the ``Astryx Props`` section below. | `None`     |
