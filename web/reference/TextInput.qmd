# TextInput { #anylumino.astryx.TextInput }
...
| input_type      | str \| None                 | HTML text input type.                                                                                         | `None`    |
...
| auto_focus      | bool \| None                | Whether to focus the input when mounted.                                                                      | `None`    |
| select_on_focus | bool \| None                | Whether focusing the input selects its content, so typing replaces the value. Off by default for text inputs. | `None`    |
