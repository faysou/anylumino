...
combine anywidgets, ipywidgets controls, charts, tables, and outputs into one
...
ipywidgets controls such as `Button(icon="check")`. In notebooks, prefer names
that are available in the Jupyter icon font, for example `plus`, `refresh`,
`comment-o`, `line-chart`, `step-forward`, `expand`, `adjust`, `check`, and
`times`.
